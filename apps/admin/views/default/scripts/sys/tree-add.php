...
<div class="tab-box">
	<ul id="nav_tabs">
		<li><a href="<?php echo $this->url("sys/tree-list");?>" >栏目列表</a></li>
		<li class="active"><a href="<?php echo $this->url("sys/tree-add");?>">栏目添加</a></li>
	</ul>
</div>
<div style="clear: both"></div>
<form name="add-tree"  method="post" action="<?php echo $this->url("sys/tree-add")?>" >
