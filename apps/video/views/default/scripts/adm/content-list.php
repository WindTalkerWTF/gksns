...
<table cellspacing="0" cellpadding="3" align="center" border="0" class="tableborder">
	<tr>
		...
		<td class="tablerow1 tablerow" width="5%" noWrap="noWrap">子集</td>
		<td class="tablerow1 tablerow" width="8%" noWrap="noWrap">栏目</td>
	...
	<tr class="tr-<?php echo $k%2==0 ? 1:2?>">
		...
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
		<a href="<?php echo $this->url("adm/sub/id/".$v['id'],"video")?>"><i class="icon-pencil"></i></a>
		</td>
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
		...
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
<input type="checkbox" name="position_index"  onclick="recommend(this,<?php echo $v['id'];?>,1)" value="1" <?php echo in_array(1, $v['p']) ? "checked":"";?>>&nbsp;&nbsp;首页头条
&nbsp;&nbsp;
