<?php 
	echo $this->cplace("添加子集");
?>
<div class="tab-box">
	<ul id="nav_tabs">
		<li><a href="<?php echo $this->url("adm/sub");?>" >子集列表</a></li>
		<li class="active"><a href="<?php echo $this->url("adm/sub-add");?>">添加子集</a></li>
	</ul>
</div>
<div style="clear: both"></div>
<form name="add-tree"  enctype="multipart/form-data"  method="post" action="<?php echo My_Tool::url("/adm/sub-add")?>" >
...
<input type="text" name="list_number" value="<?php echo $this->list_number ? $this->list_number:1; ?>" >
</td>
