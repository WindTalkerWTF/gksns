...
<?php echo $this->leftmenu($this->id);?>
 <div class="main gprefix-1 gspan-25">
    ...
    <div class="main gprefix-1 gspan-24">
        <div class="gbtitle">
            <h2><a href="<?php echo $this->url("index/index/id/".$this->id,"user")?>">个人主页</a><span class="gbtitle-point-to">&gt;</span>关注</h2>
            <span class="gbtitle-txt">(全部<span id="titleFollowingCount"><?php echo $this->user['follow_count'];?></span>人）</span>
        </div>
...
<?php if($this->isMe):?>
     <span ><a href="javascript:void 0;"  data-id="<?php echo $v['id']; ?>"  class="cancelfollow" >取消关注</a></span>
<?php endif;?>
                    </div>
                    <div class="gfollow-info">
                        <p>
                        <span>
                        <a target="_blank" href="<?php echo $this->url("index/index/id/".$v['id'],"user");?>"><?php echo $v['nickname']?></a>
                        </span>
                        <span><?php echo isset($v['stat']['follow_count']) ? $v['stat']['follow_count'] : 0;?>人关注</span>
                        </p>
                        <p>
