...
echo $this->loadscript("js/easydialog/easydialog.min.js");
echo $this->loadscript("js/easydialog/easydialog.css");
echo $this->loadscript("js/util.js");
echo $this->loadscript("js/jquerypowerfloat/powerFloat.css");
echo $this->loadscript("js/jquerypowerfloat/jquery-powerFloat.js");
echo $this->loadscript("js/jquery.qtip.min.js");
echo $this->loadscript("js/google-code-prettify/prettify.css");
echo $this->loadscript("js/google-code-prettify/prettify.js");
?>

<div class="gheader-wp" id="gheader-wp">
<div class="gheader-new">
    <div class="gh-wrap">
        <div class="gfl">
            <ul class="gh-nav">
                <li>
                    <a href="<?php echo $this->url("/index/index", "home");?>"><span class="gnicon-home"></span><?php echo getSysData('site.config.siteName');?><b></b></a>
                </li>
                <li>
        ...
        <?php if(!$this->user):?>
            <div class="gh-login">
                <?php
                        ...
                        $controll = $request->getControllerName();
                        $action = $request->getActionName();
                        if($module=='user' && $controll=='index' && $action=='login'){
                            $ref = "";
                        }else{
                            $ref = "?ref=".rawurlencode(My_Tool::getCurrentUrl());
                        }

                ?>
                <a href="<?php echo $this->url("index/login".$ref,"user");?>">登录</a>
