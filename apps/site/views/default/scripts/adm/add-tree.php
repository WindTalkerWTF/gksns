...
<div class="tab-box">
	<ul id="nav_tabs">
		...
		<li class="active"><a href="<?php echo $this->url("adm/add-tree");?>">栏目添加</a></li>
	</ul>
</div>
<div style="clear: both"></div>
<form name="add-tree"  enctype="multipart/form-data"  method="post" action="<?php echo My_Tool::url("/adm/add-tree")?>" >
...
<input type="text" name="name" value="<?php echo $this->name ? $this->name:""; ?>" >
</td>
...
<tr>
<td class="tablerow1 formrow">
<textarea rows="3" cols="80" name='descr'><?php echo $this->descr ? $this->descr:"";?></textarea>
</td>
