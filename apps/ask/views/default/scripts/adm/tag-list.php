...
<div class="tab-box">
	<ul id="nav_tabs">
		<li class="active"><a href="<?php echo $this->url("adm/tag-list");?>" >标签列表</a></li>
		<li><a href="<?php echo $this->url("adm/tag-add");?>">标签添加</a></li>
	</ul>
</div>
<form name="ss" action="<?php echo $this->url("adm/tag-list");?>" >
<div class="row-fluid">
  		    <div class="span3">
...
<table cellspacing="0" cellpadding="3" align="center" border="0" class="tableborder">
	...
	<tr class="tr-<?php echo $k%2==0 ? 1:2?>">
		...
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
<a href="<?php echo $this->url("tag/view/t/" . $v['name']);?>" target="_blank" ><i class="icon-eye-open"></i></a>
<a href="<?php echo $this->url("adm/tag-edit/id/" . $v['id']);?>" title="编辑" >
<i class="icon-pencil"></i></a>
<a  title="删除"
 href="javascript:if(confirm('确认删除吗')){ location.href='<?php echo $this->url("adm/tag-del/id/" . $v['id']);?>';}"
 ><i class="icon-trash"></i>
	...
	<?php endforeach;?>
		<tr class="tr-3">
			<td class="tablerow1" colspan="9" align="right" id="pagecode">
