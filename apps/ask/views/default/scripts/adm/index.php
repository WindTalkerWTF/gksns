<?php
echo $this->cplace("问答管理");
?>
<div class="tab-box">
	<ul id="nav_tabs">
		<li class="active"><a href="<?php echo $this->url("adm/index/tag/". $this->tag);?>" >内容列表</a></li>
	</ul>
</div>
...
<div class="row-fluid">
             ...
             <div class="span3">
                    <div class="control-group">
			              ...
			              <div class="controls">
			                <input type="text" id="tag" name="tag" value="<?php echo $this->tag ? $this->tag : '';?>" >
			              </div>
            		</div>
            </div>
            <div class="span3">
...
<table cellspacing="0" cellpadding="3" align="center" border="0" class="tableborder">
	<tr>
		...
		<td class="tablerow1 tablerow" width="10%" noWrap="noWrap">tag</td>
		<td class="tablerow1 tablerow" width="20%" noWrap="noWrap">标题</td>
		<td class="tablerow1 tablerow" width="10%" noWrap="noWrap">作者</td>
		<td class="tablerow1 tablerow" width="10%" noWrap="noWrap">关注/回答</td>
	...
	<tr class="tr-<?php echo $k%2==0 ? 1:2?>">
		...
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
		<?php echo $v['follow_count'];?>/<?php echo $v['answer_count'];?>
		</td>
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
		<?php 
			if($v['is_publish']):
