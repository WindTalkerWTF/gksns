...
<div class="tab-box">
	<ul id="nav_tabs">
		<li><a href="<?php echo $this->url("adm/tag-list");?>" >标签列表</a></li>
		<li class="active"><a href="<?php echo $this->url("adm/tag-add");?>">标签添加</a></li>
	</ul>
</div>
<div style="clear: both"></div>
<form name="add-tree"  method="post" action="<?php echo My_Tool::url("/adm/tag-edit")?>" >
