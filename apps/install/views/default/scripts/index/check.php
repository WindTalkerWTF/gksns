  ...
  <?php if(!$is_error):?>
  <div class="menu">
    <button type="button" class="submit" onclick="window.location.href='<?php echo $this->url("index/config");?>'">准备完毕进入安装</button>
  </div>
   <?php else: ?>
      <div class="menu">
