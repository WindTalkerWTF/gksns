...
<table cellspacing="0" cellpadding="3" align="center" border="0" class="tableborder">
	<tr>
		...
		<td class="tablerow1 tablerow" width="10%">小组数目</td>
	...
	<tr class="tr-<?php echo $k%2==0 ? 1:2?>">
		...
		<td class="tablerow<?php echo $k%2==0 ? 1:2?> tdborder">
<a href="<?php echo $this->url("adm/tree-edit/id/" . $v['id']);?>" title="编辑" >
<i class="icon-pencil"></i></a>
<a  title="删除"
 href="javascript:if(confirm('确认删除吗')){ location.href='<?php echo $this->url("adm/tree-del/id/" . $v['id']);?>';}"
