...
?>
	...
	<div class="cmt-img cmtImg pt-pic"><a
		...
		<img alt="<?php echo $v['user']['nickname'];?>"  src="<?php echo My_Tool::getFace($v['user']['face'],"48"); ?>">
...
<?php echo $this->paginator($this->pageSize, $this->page, $this->totalNum, "group","#comments");?>
<?php 
	endif;
?>
<?php 
...
<?php echo My_Tool_Form::start("greplyForm", $this->url('index/addreply'),"post", array("id"=>"replyForm"));?>
...
<input type="submit" value="发 布" class="gbtn-primary submit">
